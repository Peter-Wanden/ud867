...
// Create an AsyncTask to retrieve jokes using the template included int these instructions:
...
public class EndpointsAsyncTask extends AsyncTask<Pair<Context, String>, Void, String> {
    ...
    protected void onPostExecute(String myJoke) {
        // Launch the activity from your Android Library to display the joke retrieved from the
        // AsyncTask.
        Intent intent = new Intent(context, ActivityJokeDisplay.class);
        intent.putExtra(ActivityJokeDisplay.JOKE_KEY, myJoke);
        // Make sure this is the only one, if not re-use an existing.
